...
urlpatterns = [path('homework/',views.Homeworkmessages),
             ...
             path('wktest/', views.Testresult,name="wktest"),
              path('zkfxnametg/<int:id0>/<int:id1>/<int:bj>', views.zkfxnametg),
               ...
               path('hwrewardmanage/', views.Hwrewardmanage),
               ...
               path('hwunpass/<int:time>/<int:clas>/<int:ornot>', views.Showhwunpass),
               path('lucky', views.Showlucky,name='lucky'),
               path('luckys', views.Showluckys,name='luckys'),
               path('caculate', views.Caculates, name='caculate'),
               path('caculate2', views.Drawpic, name='caculate2'),
               path('hardkiller', views.Hardkiller, name='hardkiller'),
               path('hardkillershow', views.Hardkillershow),
               path('showlucky', views.Showluckynames),
               path('addlucky', views.Addlucky),
               path('getkousuan/<int:id0>/<int:id1>/<int:bj>', views.Getkousuan),
               path('addluckynum', views.Addluckynum),
               path('addluckynums', views.Addluckynums),
               ...
               path('mintestshow', views.Mintestshow),
               path('mintestshow/<int:idd>/<int:clas>', views.Mintestshowdetail),
               path('mintestaddteacher', views.Mintestaddteacher),
               path('youxi', views.Youxi),
