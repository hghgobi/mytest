...
class ZslimitAdmin(admin.ModelAdmin):
	list_display = ['name','year','month','day','num','time']
@admin.register(Sumrecord)
class SumrecordAdmin(admin.ModelAdmin):
	list_display = ['name','reason','num','clas']

@admin.register(Getlucky)
class GetluckyAdmin(admin.ModelAdmin):
	list_display = ['name','idd','time']

@admin.register(Getluckynames)
class GetluckynamesAdmin(admin.ModelAdmin):
	list_display = ['name','idd','time','num','rank']

@admin.register(Getluckyornot)
class GetluckyornotAdmin(admin.ModelAdmin):
	list_display = ['idd','ornot','time']

@admin.register(Studentids)
class StudentidsAdmin(admin.ModelAdmin):
	list_display = ['name','idd','clas']
@admin.register(Hweveryday)
class HweverydayAdmin(admin.ModelAdmin):
	list_display = ['hwname','time','num']

@admin.register(Hweverydayrecord)
class HweverydayrecordAdmin(admin.ModelAdmin):
	list_display = ['hwname','time','name','ornot','num','clas']
@admin.register(Paotui)
class PaotuiAdmin(admin.ModelAdmin):
	list_display = ['id','name','studentname','ornot','clas','ornots','time','num','jihui']

@admin.register(Mintestdata)
class MintestdataAdmin(admin.ModelAdmin):
	list_display = ['testtime','name','score','sumscore','idd','name1','name2','clas','time']
@admin.register(Mintest)
class MintestAdmin(admin.ModelAdmin):
	list_display = ['testtime','name','sumscore','idd','time']
