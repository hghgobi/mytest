...
def zkfxnametg(request,id0,id1,bj):
    ...
    #         pass
        ...
        # except:
        #     pass
    return render(request,'yuxiname2.html',{'ms':ms,'id0':id0,'id1':id1,'mss':mss,'names':names})
...
def zkfx(request,id0,id1):
    ...
    if request.method == 'POST':
        ...
        samount = get_object_or_404(Setamount12,zid=id0,jid=id1)
        n0 = samount.seta
        n1 = samount.setb
        n2 = samount.setc
        sstu = get_object_or_404(Setstrank12,sname=teststudent)
        mr = sstu.srank
